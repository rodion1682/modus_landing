                    ...
                    animateScroll: function (n, l, d) {
                      ...
                      if (m || g) {
                        ...
                        var w,
                          ...
                          P =
                            ((w = M),
                            (S = (b = p).speedAsDuration
                              ? b.speed
                              : Math.abs((w / 1e3) * b.speed)),
                            b.durationMax && S > b.durationMax
                              ? b.durationMax
                              : b.durationMin && S < b.durationMin
                              ? b.durationMin
                              : parseInt(S, 10)),
                          O = function (t) {
                            var s, i, r;
                            y || (y = t),
                              ...
                              (function (t, s) {
                                ...
                                ((h = e.requestAnimationFrame(O)), (y = t));
                          };
    ...
    (() => {
      ...
      let d = (e, t = !1, s = 500, n = 0) => {
        ...
        if (r) {
          ...
          t &&
            ((o = "header.header"),
            (d = document.querySelector(o).offsetHeight));
          let c = {
            speedAsDuration: !0,
            speed: s,
            header: o,
      ...
      const T = {
        ...
        on: function (...e) {
          ...
          function r(e) {
            ...
            if ((i.indexOf(e) < 0 && i.unshift(e), S(t).is(s))) n.apply(t, i);
            else {
              const e = S(t).parents();
              for (let t = 0; t < e.length; t += 1)
                S(e[t]).is(s) && n.apply(e[t], i);
            }
          }
          function a(e) {
        ...
        nextAll: function (e) {
          ...
          for (; s.nextElementSibling; ) {
            ...
            e ? S(n).is(e) && t.push(n) : t.push(n), (s = n);
          }
          return S(t);
        },
        prev: function (e) {
            ...
            for (let s = 0, n = e.length; s < n; s += 1) {
              ...
              void 0 !== i &&
                ...
                (M(t[n]) && M(r[n])
                  ...
                  : !M(t[n]) && M(r[n])
                  ? ((t[n] = {}),
                    r[n].__swiper__ ? (t[n] = r[n]) : $(t[n], r[n]))
                  : (t[n] = r[n]));
            }
          }
        }
      ...
      const G = {
        ...
        updateSlides: function () {
          ...
          for (let i = 0; i < p; i += 1) {
            ...
            const a = c.eq(i);
            if (
              (T && e.grid.updateSlide(i, a, p, t), "none" !== a.css("display"))
            ) {
      ...
      const F = {
        loopCreate: function () {
          ...
          for (let e = a.length - 1; e >= 0; e -= 1)
            i.prepend(E(a[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
        },
        loopFix: function () {
          const e = this;
      ...
      const Z = {
          attachEvents: function () {
            ...
            (e.onTouchStart = H.bind(e)),
              ...
              (e.onClick = X.bind(e)),
              n.touch && !Q && (t.addEventListener("touchstart", K), (Q = !0)),
              J(e, "on");
          },
      ...
      class oe {
        constructor(...e) {
          ...
          (n.__swiper__ = !0),
            (n.support = z()),
            (n.device = D({ userAgent: s.userAgent })),
            (n.browser = q()),
            (n.eventsListeners = {}),
        ...
        t({
          ...
          s("click", (t, s) => {
            const { $nextEl: i, $prevEl: r } = e.navigation,
              a = s.target;
            if (e.params.navigation.hideOnClick && !E(a).is(r) && !E(a).is(i)) {
              if (
                e.pagination &&
                e.params.pagination &&
      ...
      function ue({ swiper: e, extendParams: t, on: s, emit: n }) {
        ...
        function d() {
          ...
          if (
            ("fraction" === s.type &&
              ...
              d.find(pe(s.totalClass)).text(s.formatFractionTotal(p))),
            "progressbar" === s.type)
          ) {
            let t;
        ...
        function c() {
          ...
          if ("bullets" === t.type) {
            ...
            i.html(r), (e.pagination.bullets = i.find(pe(t.bulletClass)));
          }
          "fraction" === t.type &&
            ((r = t.renderFraction
        ...
        he(),
          document.querySelector(".products__slider") &&
            new le(".products__slider", {
              ...
              loop: !0,
              navigation: {
                nextEl: ".products__arrow_left",
                prevEl: ".products__arrow_right",
              },
              breakpoints: {
                320: { slidesPerView: 1.1, spaceBetween: 15 },
                480: { slidesPerView: 1.25, spaceBetween: 15 },
          ...
          document.querySelector(".review__slider") &&
            new le(".review__slider", {
              ...
              speed: 800,
              loop: !0,
              pagination: { el: ".review__dots", clickable: !0 },
              on: {},
            });
      });
      e.watcher = new (class {
      ...
      new me("max").init();
      let ge = document.querySelector(".cursus__counter");
      if (ge) {
        ...
        function a() {
          ...
          console.log(o, l, d, c),
            (e.innerText = o < 10 ? "0" + o : o),
            (t.innerText = l < 10 ? "0" + l : l),
            (s.innerText = d < 10 ? "0" + d : d),
            (n.innerText = c < 10 ? "0" + c : c);
        }
        console.log(r), a(), setInterval(a, 1e3);
      }
      const ve = document.querySelector(".contact-footer__to-top");
      ve &&
